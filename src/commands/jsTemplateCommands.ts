...
module.exports = async (note) => {
  // Destructure available variables
  const {
    filename,
    date,
    time,
...
module.exports = async (note) => {
  ...
  return content;
    ...
    <div class="example">
        <pre><code>module.exports = async (note) => {
