 ...
 * This now sets the global AI model preference used by templates, tagging, summarization, and search
 */
export async function handleSelectAIModel(): Promise<void> {
    try {
        // Import from aiModelService for centralized model management
        const { getAvailableModels, formatModelForDisplay } = await import('../services/aiModelService');
